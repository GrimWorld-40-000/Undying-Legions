...
// Type: GW40K_Necrons.JumpAbilityProperties
...
public class JumpAbilityProperties : CompProperties_AbilityEffect
{
  public JumpAbilityProperties() => this.compClass = typeof (JumpAbility);
}
