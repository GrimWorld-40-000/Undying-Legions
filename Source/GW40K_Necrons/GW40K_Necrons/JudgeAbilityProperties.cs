...
// Type: GW40K_Necrons.JudgeAbilityProperties
...
public class JudgeAbilityProperties : CompProperties_AbilityEffect
{
  public JudgeAbilityProperties() => this.compClass = typeof (JudgeAbility);
}
