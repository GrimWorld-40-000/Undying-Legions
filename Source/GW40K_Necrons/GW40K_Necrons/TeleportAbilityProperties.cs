...
// Type: GW40K_Necrons.TeleportAbilityProperties
...
public class TeleportAbilityProperties : CompProperties_AbilityEffect
{
  public TeleportAbilityProperties() => this.compClass = typeof (TeleportAbility);
}
